...
ui <- fluidPage(
  tags$style(HTML("
    ...
    .card-title { font-size: 24px; font-weight: bold; margin-bottom: 5px; color: black; }
  ...
  output$attendancePlot <- renderPlot({
    ggplot(attendance_data, aes(x = session, y = height, fill = status)) +
      ...
      theme(
        ...
        axis.text.x = element_text(color = "#888888", size = 9, angle = 45, hjust = 1, margin = margin(t = 5)),
